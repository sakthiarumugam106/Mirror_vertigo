        ...
        <div className="mt-8 grid md:grid-cols-2 gap-8">
          <form onSubmit={(e) => e.preventDefault()} className="rounded-xl border border-slate-200 p-6 bg-white">
            ...
            <input
              ...
              className="mt-2 w-full rounded-md border border-slate-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500"
          ...
          <div className="rounded-xl border border-slate-200 p-6 bg-white">
            ...
            <p className="mt-1 text-slate-600 text-sm">Location: Kochi, India</p>
          </div>
        </div>
      </div>
    </section>
